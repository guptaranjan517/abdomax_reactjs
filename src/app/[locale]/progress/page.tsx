  ...
  return (
    <div className="w-full bg-black mobile:pt-20 pt-16">
      ...
      <div className="grid desktop:grid-cols-2 grid-cols-1 gap-5 md:px-10 px-5 lg:px-20">
        ...
        />
        <TickCard
          text={t("tickCard.applicator")}
          background="desktop:!bg-bgTickCardRight !bg-bgTickCardLeft"
        />
        <TickCard
          text={<>{t("tickCard.fixationBelt")}</>}
          background="odd:!bg-bgTickCardLeft desktop:odd:!bg-bgTickCardLeft"
        />
        <TickCard
          text={<>{t("tickCard.intensity")}</>}
          background="desktop:!bg-bgTickCardRight !bg-bgTickCardLeft"
        />
        <TickCard
          text={t("tickCard.preparation")}
          background="odd:!bg-bgTickCardLeft desktop:odd:!bg-bgTickCardLeft"
        />
        <TickCard
          text={<>{t("tickCard.sensation")}</>}
          background="desktop:!bg-bgTickCardRight !bg-bgTickCardLeft"
        />
      </div>
      ...
      <div className="grid grid-cols-1 md:px-10 px-5 lg:px-20">
        <TickCard
          text={
            <>
              {t("tickCard.minTreatments")} <span className="text-lightGreen">6</span>, adaptée à vos objectifs et à votre IMC. Chaque séance dure <span className="text-lightGreen">30 minutes</span>, avec au moins 2 jours entre les séances.
            </>
          }
          background="odd:!bg-bgTickCardLeft desktop:odd:!bg-bgTickCardLeft"
        />
      ...
      <div className="grid desktop:grid-cols-2 grid-cols-1 gap-5 md:px-10 px-5 lg:px-20 mt-5">
        <TickCard
          text={
            <>
              {t("tickCard.contractions")} <span className="text-lightGreen">20 000</span> contractions musculaires.
            </>
          }
          background="odd:!bg-bgTickCardLeft desktop:odd:!bg-bgTickCardLeft"
        />
        <TickCard
          text={
            <>
              {t("tickCard.effects.sideEffects")}
            </>
          }
          background="desktop:!bg-bgTickCardRight !bg-bgTickCardLeft"
        />
      ...
      <div className="grid grid-cols-1 md:px-10 px-5 lg:px-20">
        <TickCard
          text={
            <>
              {t("tickCard.following")} <span className="text-lightGreen"> AbdoMax </span>{" "}
              {t("tickCard.session")} {" "}
