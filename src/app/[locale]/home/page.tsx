...
import { exerciseCardData } from "@/shared/config";
            ...
            return (
              ...
              >
                ...
                <div className="absolute inset-0 flex flex-col gap-5 items-center justify-center text-center px-8 py-4">
                  ...
                  <p className="text-white font-medium md:text-base mobile:text-sm text-base font-Public_Sans sm:mx-0 mx-2">
                    {data.text[language]}
                  </p>
                </div>
              </div>
