    ...
    <>
      <div className="w-full flex flex-col items-center pt-20 px-5">
        ...
        <p className="md:max-w-screen-md w-full md:text-lg text-sm font-normal font-Public_Sans text-white text-center my-7">
          Abdomax is the first and only non-invasive body shaping procedure that
          uses radio frequency heating for fat reduction and high intensity
          focused electromagnetic energy for muscle strengthening and toning in
          a 30-minute session.
        </p>
      </div>
