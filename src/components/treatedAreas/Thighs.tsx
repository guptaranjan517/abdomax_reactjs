...
const Thighs = () => {
  ...
  return (
    <div className="w-full 2xl:h-700 md:h-600 sm:h-500 h-full sm:bg-bgThigh bg-none bg-no-repeat bg-cover 2xl:bg-bottom md:pt-24 sm:pt-14 pt-0 md:pl-16 sm:pl-5 pl-5">
      <div className="relative sm:hidden block">
        <img src={ImageExport.THIGHSBG} alt="abs" className="h-44 sm:auto" />
