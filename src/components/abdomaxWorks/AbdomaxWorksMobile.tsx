...
const AbdomaxWorksMobile = () => {
  return (
    <Fragment>
      <div className="w-full flex flex-col items-center text-start pt-5 px-5">
        ...
        <p className="md:max-w-screen-md w-full md:text-lg text-15p font-normal font-Public_Sans text-white  my-7 text-start leading-7">
        ...
        <ul className="w-full grid gap-8">
          <li>
            ...
            <p className="text-white px-2 py-4 md:text-base text-15p leading-7">
