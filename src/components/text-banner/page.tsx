        ...
        <Fragment>
            ...
            <div className="w-full md:px-10 px-5 lg:px-20 md:py-10 py-7 mt-10 relative">
                <div className="flex gap-1 justify-center items-start mb-2 absolute top-6 sm:top-8 lg:top-12 ">
                    ...
                    <h2 className="font-bold font-DIN text-white 2xl:text-80p xl:text-6xl lg:text-5xl md:text-5xl mobile:text-3xl text-xl uppercase">{t("Course")}
                        <span className="text-lightGreen"> {t("session")}
                        </span>
                    </h2>
                </div>
                <img src="/images/session-course.png" alt="" className="w-full" />
            </div>
