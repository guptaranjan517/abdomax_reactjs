...
const Button: React.FC<ButtonProps> = (props) => {
  return (
    <Fragment>
      <button
        {...props}
        className={cn("rounded-xl bg-lightGreen h-14 sm:w-fit w-full pl-4 pr-2p flex gap-6 items-center hover:bg-lightBlue transition-colors duration-300 ease-in-out group", props.restStyle)}
      >
